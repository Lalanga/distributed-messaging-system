...
public class ServerConfig {
    ...
    public boolean      isEnableTimeSync()     { return enableTimeSync; }
    public String       getTimeSyncProtocol()  { return timeSyncProtocol; }

    // Setters
    public void setServerId(String s)          { serverId = s; }
    public void setPort(int p)                 { port = p; }
    public void setPeers(List<NodeInfo> p)     { peers = p; }
    public void setDataDir(String d)           { dataDir = d; }
    public void setHeartbeatInterval(int h)    { heartbeatInterval = h; }
    public void setElectionTimeout(int e)      { electionTimeout = e; }
    public void setReplicationFactor(int r)    { replicationFactor = r; }
    public void setConsistencyModel(String m)  { consistencyModel = m; }
    public void setEnableTimeSync(boolean e)   { enableTimeSync = e; }
    public void setTimeSyncProtocol(String p)  { timeSyncProtocol = p; }
